    ...
    firebase.auth().onAuthStateChanged((user) => {
        if (user) {
            ...
            if (uid == "VmFjXALslNhSbYff2gNeqH0eVdU2") {
                ...
                setTimeout(() => {
                    window.location = "https://flyingsonu122.github.io/Admission-Management-System//school_login.html"
                }, 1);
            }
            ...
            setTimeout(() => {
                window.location = "https://flyingsonu122.github.io/Admission-Management-System/"
            }, 10);
        }
    });
